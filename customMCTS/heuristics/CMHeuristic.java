package players.customMCTS.heuristics;
...
/*
    Modify weights to prioritise different actions
 */
public class CMHeuristic extends StateHeuristic {

    private BoardStats rootBoardStats;

    public CMHeuristic(GameState root) {
    ...
    public static class BoardStats
    {
         ...
         * @return a score [0, 1]
         */
        double score(CMHeuristic.BoardStats futureState)
        {
